 ...
 * The initialization method that initializes everything the component needs for doing its work. It is called during the profile server startup.
...
The component manager also manages the global shutdown signaling mechanism, which helps proper termination of each component during the shutdown.
