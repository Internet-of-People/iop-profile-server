...
namespace ProfileServerProtocolTestsExecutor
{
  ...
  public class Program
  {
    ...
    public static List<Test> Tests = new List<Test>()
    {
      ...
      new Test("PS00006", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16988" }, true),
      new Test("PS00007", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16988" }, true),
      new Test("PS00008", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16988" }, true),
      new Test("PS00009", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16988" }, true),
      ...
      new Test("PS05005", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16987" }, true),
      ...
      new Test("PS05020", "ProfileServer-default.conf",          new string[] { "127.0.0.1", "16987" }, true),
