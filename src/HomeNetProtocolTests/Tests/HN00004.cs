...
namespace HomeNetProtocolTests.Tests
{
  ...
  /// https://github.com/Internet-of-People/message-protocol/blob/master/TESTS.md#hn00004---disconnection-of-inactive-tcp-client-from-primary-port---incomplete-header
  /// </summary>
