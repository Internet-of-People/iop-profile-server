...
namespace HomeNetProtocolTests.Tests
{
  ...
  /// https://github.com/Internet-of-People/message-protocol/blob/master/TESTS.md#hn00005---disconnection-of-inactive-tcp-client-from-primary-port---incomplete-message
  /// </summary>
