...
namespace HomeNetProtocolTests.Tests
{
  ...
  /// https://github.com/Internet-of-People/message-protocol/blob/master/tests/HN00.md#hn00006---disconnection-of-inactive-tcp-client-from-non-customer-port---no-message
  /// </summary>
